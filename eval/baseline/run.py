...
def run_baseline(config: BaselineConfig, verbose=True):
    ...
    for epoch in range(1, config.epochs + 1):
        ...
        # Reclaim every intermediate tensor created this epoch (forward,
        # backward, and the val forward if it ran) except the model's own
        # parameters. See mendel_core.free_all_except -- without this,
        # long training runs leak memory unboundedly and eventually OOM.
